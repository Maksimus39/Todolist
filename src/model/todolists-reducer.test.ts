...
test('correct todolist should change its name', () => {
    ...
    const newTitle = 'New Todolist'
    const endState = todolistsReducer(startState, changeTodolistTitleAC(id, newTitle))
...
test('correct filter of todolist should be changed', () => {
    ...
    const endState = todolistsReducer(startState, changeTodolistFilterAC(filter,id))
