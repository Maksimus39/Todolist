...
test('the title of the specified task must be changed', () => {
    const startState: TasksStateType = {
        'todolistId1': [
            {id: '1', title: 'CSS', isDone: false},
            {id: '2', title: 'JS', isDone: true},
    ...
    const action = changeTaskTitleAC('todolistId2', '3', 'cigarettes',)

    const endState = tasksReducer(startState, action)

    expect(endState['todolistId2'][2].title).toBe('cigarettes')
